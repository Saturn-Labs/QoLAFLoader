package {
	...
	public class AstrofluxDesktop extends Sprite {
		private const SWF_URL:String = "http://r.playerio.com/r/rymdenrunt-k9qmg7cvt0ylialudmldvg/Preload.swf";
		...
		public function AstrofluxDesktop() {
			BG = bg_jpg$a7c0ea5b86b7b87933c4ba05b43fc8801689124682;
			background = new BG();
			Loading = loading_png$3db4966a53dd72fedc5843641e385e531471585260;
		...
		private function loadExternalSWF() : void {
			...
			request = new URLRequest("https://github.com/GoranPetrusev/AstroFlux_Client/raw/master/client.swf");
