package
{
	...
	public class Popup extends Sprite
	{
		...
		public function Popup(param1:String, param2:Function)
		{
			...
			addChild(tf);
			addChild(okText);
			okText.addEventListener("click", (function():Function
			{
				var yesClickHandler:Function;
				return yesClickHandler = function(param1:MouseEvent):void
				{
